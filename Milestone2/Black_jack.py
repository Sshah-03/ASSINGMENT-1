    ...
    while True:
        try:
            ...
            if chips.bet > chips.total:
                print("Sorry, you do not have enough number of chips.You only have: {} ".format(chips.total))
            else:
                break
...
def hit_or_stand(deck, hand):
    ...
    while True:
        ...
        if x[0].lower() == 'h':
            ...
            print("Player stands so, its dealer's turn.")
            playing = False
        else:
            print("Sorry, I didn't understand your command please enter 'h' or 's' ")
            continue
        break
