...
class DoubleLinkedList(object):
    ...
    def create_list(self):
        ...
        while True:
            try:
                data = int(input("Enter the element of the list: "))
    ...
    def delete_node(self, x):
        ...
        if self.start.next is None:
            if self.start.info == x:
                ...
                print(x, "is not there in the lsit. ")
            return
        if self.start.info == x:
            self.start = self.start.next
            self.start.prev = None
...
while True:
    ...
    print("3. Insert a node at the beggining of the list.")
    ...
    if option == 1:
        ...
        data = int(input("Enter an element you want to insert: "))
        ...
        x = int(input("Enter the element before which you want to insert: "))
        data = int(input("Enter an element you want to insert: "))
