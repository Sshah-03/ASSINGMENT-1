...
n = get_integer_input("Enter number of nodes: ")

for i in range(n):
    data = get_integer_input("Enter element: ")
    list.insert_at_end(data)


while True:
    print("\n1. Display the list.")
    print("2. Count the number of nodes in the list.")
    print("3. Search for an element.")
    print("4. Insert in the begining of the list.")
    print("5. Insert at the end of the list.")
    print("6. Insert an element after a specifies node.")
    print("7. Insert an element before a specified node.")
    print("8. Insert a node at given position.")
    print("9. Delete first node.")
    print("10. Delete last node.")
    print("11. Deelete any node.")
    ...
    if option == 1:
        ...
        data = int(input("Enter element you want to insert at the end: "))
        list.insert_at_end(data)
    elif option == 6:
        data = int(input("Enter the element you want to insert: "))
        x = int(input("Enter the element after you want to insert: "))
        list.insert_after(data, x)
    elif option == 7:
        data = int(input("Enter the element you want to insert: "))
        x = int(input("Enter the element before you want to insert: "))
        list.insert_before(data, x)
    elif option == 8:
        data = int(input("Enter the element you want to insert: "))
        k = int(input("Enter the position where you want to insert: "))
